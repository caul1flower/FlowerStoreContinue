...
class RibbonDecoratorTest {
    ...
    void setUp() {
        ...
        decoratedBucket = new RibbonDecorator(bucket);
    }
    @Test
    void getPrice() {
        assertEquals(40.0, decoratedBucket.getPrice());
    }

    @Test
    void getDescription() {
        assertEquals("A bucket of flowers with ribbon.", decoratedBucket.getDescription());
    }
